...
<style>
    /* ---------------------------------------------------------
       Strictly Scoped CSS Hierarchy for HerStay
       Target: #herstay-case-study.herstay-page
       --------------------------------------------------------- */
    #herstay-case-study.herstay-page {
        /* HerStay Theme Color */
        --herstay-primary: #ff4d6d;
        --herstay-secondary: #ff758f;
    }

    /* App Placeholder Styling */
    #herstay-case-study.herstay-page .herstay-app-placeholder {
        border: 2px dashed #e0e0e0;
        background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);
    }

    /* Objective Wrapper */
    #herstay-case-study.herstay-page .herstay-objective-wrapper {
        position: relative;
        overflow: hidden;
    }

    /* Solution Image Wrapper */
    #herstay-case-study.herstay-page .herstay-solution-image-wrapper {
        transition: transform 0.3s ease;
    }

    #herstay-case-study.herstay-page .herstay-solution-image-wrapper:hover {
        transform: translateY(-5px);
    }

    /* Feature Items */
    #herstay-case-study.herstay-page .herstay-feature-item {
        transition: all 0.3s ease;
    }

    #herstay-case-study.herstay-page .herstay-feature-item:hover {
        transform: translateX(5px);
    }

    /* Product Cards */
    #herstay-case-study.herstay-page .herstay-product-card {
        transition: all 0.3s ease;
    }

    #herstay-case-study.herstay-page .herstay-product-card:hover {
        transform: translateY(-8px);
        box-shadow: 0 15px 30px rgba(255, 77, 109, 0.15);
        border-color: var(--herstay-primary);
    }

    #herstay-case-study.herstay-page .herstay-product-card:hover .icon-wrapper {
        background: var(--herstay-secondary);
    }

    /* Timeline Icon Override for HerStay */
    #herstay-case-study.herstay-page .timeline-icon {
        background: var(--herstay-primary) !important;
    }

    #herstay-case-study.herstay-page .timeline-icon.bg-info {
        background: var(--herstay-primary) !important;
    }

    #herstay-case-study.herstay-page .timeline-icon.bg-warning {
        background: var(--herstay-secondary) !important;
    }

    #herstay-case-study.herstay-page .timeline-icon.bg-primary {
        background: var(--herstay-primary) !important;
    }

    #herstay-case-study.herstay-page .timeline-icon.bg-secondary {
        background: #6c757d !important;
    }

    #herstay-case-study.herstay-page .timeline-icon.bg-success {
        background: #28a745 !important;
    }

    /* Service Card Icon Override */
    #herstay-case-study.herstay-page .service-card-items .icon {
        color: var(--herstay-primary) !important;
    }

    /* Tech Category Box Icon Override */
    #herstay-case-study.herstay-page .tech-category-box h4 i {
        color: var(--herstay-primary) !important;
    }
    ...
    @media (max-width: 768px) {
        ...
        #herstay-case-study.herstay-page .herstay-objective-content h3 {
            font-size: 16px !important;
        }

        #herstay-case-study.herstay-page .herstay-objective-content p {
            font-size: 16px !important;
        }
    }
</style>
        ...
        <div class="section-title-area d-flex flex-wrap justify-content-between align-items-start mb-5">
            <div class="section-title mb-0">
                <h2 class="wow fadeInUp" data-wow-delay=".3s">
                    HerStay – Women-First Travel & <br>Accommodation Platform
                </h2>
            ...
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="about-image">
                        <div class="herstay-app-placeholder" style="background: #f8f9fa; min-height: 450px; display: flex; align-items: center; justify-content: center; border-radius: 12px; border: 1px dashed #ccc;">
                            <span class="text-muted">App Interface Image</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <div class="container">
        ...
        <div class="section-title-area d-flex flex-wrap justify-content-between align-items-start mb-5">
            <div class="section-title col-lg-6">
                ...
                <h2 class="wow fadeInUp" data-wow-delay=".3s">
                    Challenges Women Travelers Face
                </h2>
                <p class="section-title-desc wow fadeInUp" data-wow-delay=".4s">
...
<section class="service-section fix section-padding" style="background: #fff;">
    ...
    <div class="container">
        ...
        <div class="row mb-5 wow fadeInUp" data-wow-delay=".2s">
            <div class="col-12">
                <div class="herstay-objective-wrapper text-center"
                    style="background: linear-gradient(135deg, #ff4d6d 0%, #ff758f 100%); padding: 40px 30px; border-radius: 16px; position: relative; overflow: hidden;">
                    <div class="herstay-objective-content" style="position: relative; z-index: 2;">
                        ...
                        <p class="text-white mb-0" style="font-size: 20px; line-height: 1.6; font-weight: 500; max-width: 900px; margin: 0 auto;">
                            Create a women-first travel ecosystem that connects travelers with compatible companions, accommodation opportunities, and a supportive community all through one intuitive mobile experience.
                        </p>
                    </div>
                    <div class="herstay-objective-bg"
                    ...
                    <div class="herstay-objective-bg-2"
        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay=".3s">
                <div class="herstay-solution-image-wrapper"
                    style="position: relative; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 40px rgba(255, 77, 109, 0.15);">
                    <div class="herstay-app-placeholder" style="background: #f8f9fa; min-height: 400px; display: flex; align-items: center; justify-content: center; border-radius: 20px;">
                        <span class="text-muted">App Interface Image</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay=".4s">
                <div class="section-title">
                    <div class="sub-title wow fadeInUp" style="background: #ff4d6d; color: #fff; display: inline-block; padding: 8px 20px; border-radius: 25px; font-size: 12px; font-weight: 600; letter-spacing: 1px; text-transform: uppercase;">
                ...
                <div class="herstay-solution-features mt-4">
                    ...
                    <div class="herstay-feature-item d-flex align-items-start mb-4 wow fadeInUp" data-wow-delay=".5s"
                        ...
                        <div class="feature-number me-3"
                            style="width: 40px; height: 40px; background: #ff4d6d; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
...
<section class="journey-section fix section-padding mt-0" style="background: #fff">
    <div class="container">
        <!-- Section Title Area -->
        <div class="section-title-area d-flex flex-wrap justify-content-between align-items-start mb-5">
            <div class="section-title col-lg-6">
                ...
                <div class="timeline-centered">
                    ...
                    <article class="timeline-entry wow fadeInUp" data-wow-delay=".2s">
                        <div class="timeline-entry-inner">
                            ...
                            <div class="timeline-label">
                                ...
                                <p>Tell the community about your travel interests, destinations, preferences, and upcoming plans.</p>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="timeline-entry left-aligned wow fadeInUp" data-wow-delay=".3s">
                        <div class="timeline-entry-inner">
                            ...
                            <div class="timeline-label">
                                <h2>Discover Travelers & Trips</h2>
                                <p>Explore destinations, travel opportunities, accommodation options, and women with similar travel interests.</p>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="timeline-entry wow fadeInUp" data-wow-delay=".4s">
                        <div class="timeline-entry-inner">
                            ...
                            <div class="timeline-label">
                                <h2>Connect & Match</h2>
                                <p>Find compatible travelers, view profiles, and start private conversations to discuss plans and shared interests.</p>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="timeline-entry left-aligned wow fadeInUp" data-wow-delay=".5s">
                        <div class="timeline-entry-inner">
                            ...
                            <div class="timeline-label">
                                <h2>Travel & Build Connections</h2>
                                <p>Plan your journey, discover opportunities nearby, and create meaningful connections with women along the way.</p>
                            </div>
                        </div>
                    </article>
    ...
    <div class="container">
        <div class="section-title-area d-flex flex-wrap justify-content-between align-items-end mb-5">
            <div class="section-title mb-0">
                ...
                <p class="section-title-desc wow fadeInUp" data-wow-delay=".4s">
                    Take a look at the key features and screens of the HerStay travel platform.
                </p>
            </div>
        </div>
        ...
        <div class="row g-3 g-md-4">
            ...
            <div class="col-6 col-md-4 col-lg-2 wow fadeInUp" data-wow-delay=".1s">
                <div class="herstay-product-card h-100 text-center"
                    ...
                    <div class="icon-wrapper mb-3"
                        style="width: 60px; height: 60px; margin: 0 auto; background: #ff4d6d; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                        <i class="fa-solid fa-compass" style="color: #fff; font-size: 24px;"></i>
                    </div>
            ...
            <div class="col-6 col-md-4 col-lg-2 wow fadeInUp" data-wow-delay=".3s">
                <div class="herstay-product-card h-100 text-center"
                    ...
                    <div class="icon-wrapper mb-3"
                        style="width: 60px; height: 60px; margin: 0 auto; background: #ff4d6d; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                        <i class="fa-solid fa-user-group" style="color: #fff; font-size: 24px;"></i>
                    </div>
                    <h6 class="fw-bold mb-0" style="color: #333; font-size: 14px; line-height: 1.4;">
                        Companion Matching
                    </h6>
            ...
            <div class="col-6 col-md-4 col-lg-2 wow fadeInUp" data-wow-delay=".5s">
                <div class="herstay-product-card h-100 text-center"
                    ...
                    <div class="icon-wrapper mb-3"
                        style="width: 60px; height: 60px; margin: 0 auto; background: #ff4d6d; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                        <i class="fa-solid fa-hotel" style="color: #fff; font-size: 24px;"></i>
                    </div>
                    <h6 class="fw-bold mb-0" style="color: #333; font-size: 14px; line-height: 1.4;">
                        Accommodation
                    </h6>
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay=".2s">
                        <div class="tech-category-box h-100"
                            ...
                            <h4 style="font-size: 20px; font-weight: 700; margin-bottom: 15px;"><i
                                    ...
                                    style="color: #ff4d6d; margin-right: 8px;"></i> Frontend / Mobile App
                            </h4>
                            <div class="tech-list">
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="tech-category-box h-100"
                            ...
                            <h4 style="font-size: 20px; font-weight: 700; margin-bottom: 15px;"><i
                                    ...
                                    style="color: #ff4d6d; margin-right: 8px;"></i> Backend
                            </h4>
                            <div class="tech-list">
                                <p style="color: #666; margin: 0; line-height: 1.6;">
                                    Node.js • Express.js
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay=".4s">
                        <div class="tech-category-box h-100"
                            ...
                            <h4 style="font-size: 20px; font-weight: 700; margin-bottom: 15px;"><i
                                    ...
                                    style="color: #ff4d6d; margin-right: 8px;"></i> Database
                            </h4>
                            <div class="tech-list">
                                <p style="color: #666; margin: 0; line-height: 1.6;">
                                    MongoDB
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="tech-category-box h-100"
                            ...
                            <h4 style="font-size: 20px; font-weight: 700; margin-bottom: 15px;"><i
                                    ...
                                    style="color: #ff4d6d; margin-right: 8px;"></i> APIs & Integrations
                            </h4>
                            <div class="tech-list">
                                <p style="color: #666; margin: 0; line-height: 1.6;">
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay=".6s">
                        <div class="tech-category-box h-100"
                            ...
                            <h4 style="font-size: 20px; font-weight: 700; margin-bottom: 15px;"><i
                                    ...
                                    style="color: #ff4d6d; margin-right: 8px;"></i> Cloud & Deployment
                            </h4>
                            <div class="tech-list">
                                <p style="color: #666; margin: 0; line-height: 1.6;">
                                    AWS • Cloud Services
        ...
        <div class="row g-4">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-12 wow fadeInUp" data-wow-delay=".2s">
                <div class="service-card-items h-100"
                    ...
                    <div class="icon mb-3" style="font-size: 24px; color: #ff4d6d;">
                        <i class="fa-solid fa-heart"></i>
                    </div>
