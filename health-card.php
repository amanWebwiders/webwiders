    ...
    <div class="container">
        <div class="page-heading">
            <div class="breadcrumb-sub-title">
                <h1 class="wow fadeInUp" data-wow-delay=".3s">Health Card</h1>
            </div>
            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="details-image">
                        <img src="assets/img/healthcare.png" alt="Health ERP Dashboard"
                    ...
                    <div class="project-details-content ps-lg-4">
                        <div class="details-left">
                            <div class="section-title">
                                <div class="sub-title bg-color-2 wow fadeInUp"
                                    ...
                                    <span>Heath Care ERP Solution</span>
                                </div>
                            </div>
                            <h2>Complete Hospital Management ERP</h2>
                            <!-- Tagline/Highlight -->
                            <h5 class="mt-3 mb-4" style="color: var(--theme, #6A47ED); font-weight: 600;">For Modern
                                Healthcare Professionals</h5>

                            <p class="mb-4">
                                Manage Patients, Doctors, Pharmacy, Laboratory, Billing, and HR from a single,
                                cloud-based platform. Streamline your hospital operations with our highly secure and
                        ...
                        <div class="mt-4 d-flex gap-3">
                            <a href="#demo-section" class="theme-btn">
                                Book a Free Demo <i class="fa-solid fa-laptop-medical"></i>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="project-details-content mb-5">
                        <h3>What is Health ERP?</h3>
                        <p class="mt-3 mb-4">
                            Health ERP is a completely integrated hospital management system designed to manage all
                            aspects of a hospital's operation. From patient registration to discharge, billing, and
                            pharmacy management, our ERP ensures smooth workflows, minimizes administrative errors, and
                            improves patient care.
                        </p>

                        <h3 class="mt-5 mb-3">Complete Hospital Management Modules</h3>
                        <div class="list-items">
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <ul class="d-flex flex-column gap-3">
                                        <li><span><i class="fa-solid fa-check me-2" style="color: #6A47ED;"></i>
                                                <strong>Patient Management:</strong> Track records, admission, and
                                                discharge.</span></li>
                                        <li><span><i class="fa-solid fa-check me-2" style="color: #6A47ED;"></i>
                                                <strong>Doctor Management:</strong> Appointment scheduling and duty
                                                rosters.</span></li>
                                        <li><span><i class="fa-solid fa-check me-2" style="color: #6A47ED;"></i>
                                                <strong>Billing & Invoicing:</strong> Automated billing, insurance
                                                claims, and tax.</span></li>
                                        <li><span><i class="fa-solid fa-check me-2" style="color: #6A47ED;"></i>
                                                <strong>Pharmacy:</strong> Inventory management, expiry alerts, and
                                                sales.</span></li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
                                    <ul class="d-flex flex-column gap-3">
                                        <li><span><i class="fa-solid fa-check me-2" style="color: #6A47ED;"></i>
                                                <strong>Laboratory:</strong> Manage lab tests, sample collection, and
                                                reporting.</span></li>
                                        <li><span><i class="fa-solid fa-check me-2" style="color: #6A47ED;"></i>
                                                <strong>HR Management:</strong> Staff payroll, attendance, and
                                                leaves.</span></li>
                                        <li><span><i class="fa-solid fa-check me-2" style="color: #6A47ED;"></i>
                                                <strong>Front Desk:</strong> Streamline inquiries and visitor
                                                management.</span></li>
                                        <li><span><i class="fa-solid fa-check me-2" style="color: #6A47ED;"></i>
                                                <strong>Reports & Analytics:</strong> Real-time graphical insights and
                                                data.</span></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <h3 class="mt-5 mb-3">Why People Choose Us</h3>
                        <p class="mb-4">
                            Trusted by 500+ healthcare professionals. We provide a highly secure, data-compliant system
                            with zero downtime, ensuring your hospital runs 24x7 without any technical hurdles.
                        </p>
                    </div>
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-clt">
                                                ...
                                                <input type="email" name="email" placeholder="john@hospital.com"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-clt">
                                                ...
                                                <input type="text" name="hospital" placeholder="City Care Hospital"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                        ...
                        <div class="single-sidebar-widget">
                            ...
                            <div class="news-widget-categories">
                                <ul class="d-flex flex-column gap-2">
                                    <li><i class="fa-solid fa-shield-halved me-2 text-success"></i> HIPAA Compliant</li>
                        ...
                        <div class="single-sidebar-widget">
                            ...
                            <div class="news-widget-categories">
                                <ul>
                                    ...
                                    <li><a href="#">Doctors</a> <span>(OPD/IPD)</span></li>
                                    <li><a href="#">Pharmacist</a> <span>(Inventory)</span></li>
                                    <li><a href="#">Accountant</a> <span>(Billing)</span></li>
                                    <li><a href="#">Receptionist</a> <span>(Front Desk)</span></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="recent-post-area">
                                <div class="recent-items align-items-center">
                                    ...
                                    <div class="recent-content">
                                        ...
                                        <span class="fs-6 text-muted">For staff attendance</span>
                                    </div>
                                </div>
                                <div class="recent-items align-items-center mt-3">
                                    ...
                                    <div class="recent-content">
                                        ...
                                        <span class="fs-6 text-muted">Patient notifications</span>
                                    </div>
                                </div>
                            </div>
                        </div>
