...
<section class="hero-section fix hero-1 bg-cover" style="background-image: url('assets/img/hero/hero-bg.jpg');">
    ...
    <div class="container-fluid">
        <div class="hero-title wow img-custom-anim-left mb-5" data-wow-duration="1.5s" data-wow-delay="0.3s">
            <img src="assets/img/hero/hero-text.png" alt="img">
        </div>
        <div class="row g-4 align-items-center py-5 my-5">
            <div class="col-xl-5 col-lg-6">
                <div class="hero-content">
                    <span class="wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.2s">Welcome to Webwiders Solutions</span>
                    <h1 class="wow img-custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.2s">Innovative IT & AI Solutions</h1>
                    <p class="wow fadeInUp" data-wow-delay=".3s">
                        We build modern, scalable web solutions and empower businesses
                        through digital transformation and AI-driven technology.
                    </p>
                </div>
            </div>
            <div class="col-xl-4 col-lg-6">
                <div class="hero-image">
                    <img src="assets/img/hero/hero-image-3.png" alt="img" class=" wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    <div class="bg-shape">
            ...
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="about-image">
                        <img src="assets/img/about/01.png" alt="img" class="wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                        <div class="bg-shape">
                ...
                <div class="col-lg-6">
                    <div class="about-content">
                        ...
                        <p class="mt-3 mt-md-0 mb-4 wow fadeInUp" data-wow-delay=".5s">
                            Webwiders is a software development service provider.We provide services that are focused, tailored and cost-effective to suite customer needs and budget. We are equipped to address all strategic and technological issues, including software development, website development of companies with Content strategies, Corporate identity &amp; branding, E-Commerce solutions, Multi-tiered web-based application development, CRM solutions, and Supply chain management. We also involve graphics designers who work in synergy, catering not only for the look-and-feel, but the total user experience, from the human interface to addressing their requirements and meeting web application objectives. We aim at developing robust IT solutions and provide complete support to our clients.
                        </p>
                        <!-- <p class="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                            So please don’t hesitate to contact us and get to meet our team and learn more about our web design, web development, mobile application development services, graphics designing and SEO services. We are sure you will be impressed at our team’s knowledge and determination to help you find the best and give you ideas to help with your business like none other. Contact us today!!
                        </p> -->
                    ...
                    <div class="case-study-box-items">
                        <div class="thumb">
                            ...
                            <div class="post-box-items">
                                <ul>
                                    <li>
                                        <a href="#">Real-time Analytics <i class="fa-solid fa-turn-up"></i></a>
                                    </li>
                                    <li>
                                        <a href="#">Social <i class="fa-solid fa-turn-up"></i></a>
                                    </li>
                                </ul>
                                <ul>
                                    <li>
                                        <a href="#">Agile Advance <i class="fa-solid fa-turn-up"></i></a>
                                    </li>
                                    <li>
                                        <a href="#">Advance <i class="fa-solid fa-turn-up"></i></a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="main-box">
                        <div class="box wow fadeInUp">
                            <div class="title-items">
                                <h3><a href="#">Free After Sale Support</a></h3>
                            ...
                            <div class="project-content">
                                ...
                                <p>
                                    With each of our website design and development package, we offer free technical support up-to a period of 1 year.
                                </p>
                        ...
                        <div class="box bg-1 wow fadeInUp wow" data-wow-delay=".2s">
                            <div class="title-items">
                                <h3><a href="#">Affordable Pricings</a></h3>
                            ...
                            <div class="project-content">
                                <h3><a href="#">Affordable Pricings</a></h3>
                                <p>
                                    Our pricing policy is suitable for everyone, whether you are a startup entrepreneur or a medium sized commercial organization.
                                </p>
                                <a href="#" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                        <div class="box bg-2 active wow fadeInUp wow" data-wow-delay=".4s">
                            ...
                            <div class="project-content">
                                <h3><a href="#">Quality First</a></h3>
                                <p>
                                    We believe maintaining proper quality of services should be the first priority of any service firm and we do the same at Web Widers.
                                </p>
                                <a href="#" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                        <div class="box bg-3 wow fadeInUp wow" data-wow-delay=".6s">
                            <div class="title-items">
                                <h3><a href="#">More into Conversion</a></h3>
                            ...
                            <div class="project-content">
                                <h3><a href="#">More into Conversion</a></h3>
                                <p>
                                    We primarily focus on bringing more leads and converting them into potential buyers of the website we develop.
                                </p>
                                <a href="#" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                            </div>
                        </div>
...
<section class="audience-section fix section-padding bg-cover d-none" style="background-image: url('assets/img/audience-bg.jpg');">
    <div class="container">
...
<!-- Team Section Start -->
<section class="team-section fix section-padding d-none">
    <div class="container">
        <div class="team-wrapper">
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="team-image">
                        <img src="assets/img/team/01.png" alt="img" class="wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
...
<!-- News Section Start -->
<section class="news-section section-padding section-bg d-none">
...
<!-- Cta Section Start -->
<section class="cta-section section-bg section-padding pb-0 d-none">
