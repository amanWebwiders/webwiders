...
document.addEventListener("DOMContentLoaded", function () {
  const filterButtons = document.querySelectorAll(".filters-btns");
  const items = document.querySelectorAll("#filter-wrapper");
